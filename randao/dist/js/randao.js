(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("randao", [], factory);
	else if(typeof exports === 'object')
		exports["randao"] = factory();
	else
		root["randao"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mouseTracker = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _progress = __webpack_require__(7);
	...
	var mouseTracker = {
	  ...
	  init: function init() {
	    ...
	    _progress2.default.init();
	
	    $(document).on("mousemove", '#randao-box', function (e) {
	      _this.mouseInside = true;
	      _this.move(e);
	    });
	
	    $(document).on("mouseleave", '#randao-box', function (e) {
	  ...
	  move: function move(position) {
	    ...
	    if (this.count % 10 == 1) {
	      if (this.max--) {
	        var num = _util2.default.randomNum(X, Y, new Date().getTime());
	
	        this.string += this.chars.charAt(num % this.chars.length);
	        $("#code").html(this.string);
	
	        _progress2.default.growth();
	      } else {
...
/***/ function(module, exports) {
	...
	var Util = {
	  ...
	  randomNum: function randomNum(x, y, time) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vivus = __webpack_require__(8);
	...
	var progress = {
	  ...
	  vivus: null,
	  init: function init() {
	    this.vivus = new _vivus2.default('randao-progress', {
	      type: 'async',
	      duration: 150,
	      start: 'manual'
	    });
